...
class Book
{
	...
	Book(int id, String title, String author,  BookCategory category)
	{
		this.id=id;
		this.title=title;
		this.author=author;
...
{ 
	...
	{ 
        ...
        System.out.print("Enter Category of Books: "); 
...
{ 
	...
	{ 
        if (count == 0)
		{ 
            throw new BookNotFoundException("  No books available to be updated."); 
        } 
